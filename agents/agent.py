...
class Agent:
    ...
    def __init__(self):
        ...
        # Use ChatOpenAI for proper tool binding
    ...
    def email_sender(self, state: AgentState):
        print('Sending email')
        # Use ChatOpenAI for email generation
        email_llm = ChatOpenAI(model='gpt-4o', temperature=0.1)
        email_message = [SystemMessage(content=EMAILS_SYSTEM_PROMPT),
        ...
        msg.add_alternative(email_response.content, subtype='html')
